export default function Steps(){
    return(
        <main>
            <section
                className="relative py-14 md:py-32 bg-[url('/patern.webp')] bg-cover bg-center bg-no-repeat"
            >
                ...
                <div className="items-stretch relative w-full px-3 md:px-16 mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-7 mb-20">
                        ...
                        <span className="text-[#909090] text-base md:text-xl text-center md:text-left self-end max-w-md w-2/3 mx-auto lg:ml-auto">
