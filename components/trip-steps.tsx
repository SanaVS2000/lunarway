export default function Steps(){
    return(
        <main>
            <section
                className="relative py-40 bg-[url('/patern.webp')] bg-cover bg-center bg-no-repeat"
            >
                
                <div className="items-stretch relative w-full px-3 md:px-10 mx-auto">
                    {/* Header */}
                    <div className="grid lg:grid-cols-2 gap-12 mb-20">
                        <h2 className="text-2xl md:text-5xl text-center md:text-left font-bold text-gray-900 md:leading-[1.2]">
                            Plan Your Trip In <br /> Simple Steps
                        </h2>
        
                        <span className="text-base text-center md:text-left self-end text-gray-600 max-w-md lg:ml-auto">
