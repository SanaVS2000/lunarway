...
export default function About(){
    return(
        <main>
            ...
            {/* Steps */}
            <section className="relative bg-[#f2f2f2] w-full py-40">
                <div className="max-w-4/6 mx-auto px-3 md:px-10">
                    {/* Header */}
                    <div className="grid lg:grid-cols-2 gap-12 mb-20">
                    <h2 className="text-3xl md:text-5xl font-bold leading-tight text-black text-center md:text-left">
                      How We Plan <br/>
                      Every Journey
                    </h2>
        
                    <p className="text-gray-600 max-w-md lg:ml-auto text-center md:text-left">
